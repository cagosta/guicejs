...
/**
 * Array.nocomplex version: "0.0.21" Copyright (c) 2011-2012, Cyril Agosta ( cyril.agosta@gmail.com) All Rights Reserved.
...
if ( synchronous ) { // case standalone
    ...
    var ArrayNocomplex = requirejs( 'Array.nocomplex/Array.nocomplex' )

    engine.exports( 'ArrayNocomplex', ArrayNocomplex )


} else {

    requirejs( [ 'Array.nocomplex/Array.nocomplex' ], function( ArrayNocomplex ) {
        engine.exports( 'ArrayNocomplex', ArrayNocomplex )
    } )

}
;
define("Array.nocomplex/main", function(){});
}());